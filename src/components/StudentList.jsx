    ...
    return (
        <div className="max-w-4xl mx-auto mt-12 p-6 bg-gradient-to-br from-blue-50 to-white rounded-3xl shadow-xl">
            ...
            <div className="overflow-hidden rounded-xl border border-blue-200 shadow">
                <table className="min-w-full divide-y divide-blue-100 border-collapse">
                    <thead className="bg-blue-200">
                        <tr>
                            <th className="px-6 py-4 text-left text-sm font-bold text-blue-900 uppercase tracking-wider border-b border-blue-300">Tên</th>
                            <th className="px-6 py-4 text-left text-sm font-bold text-blue-900 uppercase tracking-wider border-b border-blue-300">Lớp</th>
                            <th className="px-6 py-4 text-left text-sm font-bold text-blue-900 uppercase tracking-wider border-b border-blue-300">Tuổi</th>
                            <th className="px-6 py-4 text-center text-sm font-bold text-blue-900 uppercase tracking-wider border-b border-blue-300">Hành động</th>
                        </tr>
                    </thead>
